...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1):
        select = torch.ops.aten.select.int(arg0_1, 2, 3);  arg0_1 = None
        eq = torch.ops.aten.eq.Scalar(select, 0);  select = None
        convert_element_type = torch.ops.prims.convert_element_type.default(eq, torch.float32);  eq = None
