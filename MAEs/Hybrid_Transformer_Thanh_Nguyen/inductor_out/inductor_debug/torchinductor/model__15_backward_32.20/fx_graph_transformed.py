class GraphModule(torch.nn.Module):
    def forward(self, primals_2: "f32[128, 512]", primals_5: "f32[128]", primals_7: "f32[384, 128]", primals_9: "f32[128, 128]", primals_13: "f32[128]", primals_15: "f32[128]", primals_17: "f32[512, 128]", primals_19: "f32[512]", primals_21: "f32[128, 512]", view: "f32[64000, 512]", gt: "b8[500, 128, 128]", mul_2: "f32[500, 128, 128]", view_2: "f32[64000, 128]", baddbmm: "f32[4000, 128, 128]", amax: "f32[4000, 128, 1]", sum_1: "f32[4000, 128, 1]", gt_1: "b8[4000, 128, 128]", view_10: "f32[64000, 128]", addmm_1: "f32[64000, 128]", getitem_3: "f32[500, 128, 1]", rsqrt_1: "f32[500, 128, 1]", gt_2: "b8[500, 128, 128]", mul_11: "f32[500, 128, 128]", view_13: "f32[64000, 128]", addmm_2: "f32[64000, 512]", gt_3: "b8[500, 128, 512]", getitem_7: "f32[500, 128, 1]", rsqrt_3: "f32[500, 128, 1]", view_15: "f32[64000, 512]", gt_4: "b8[500, 128, 128]", div_2: "f32[500, 128, 1]", permute_27: "f32[4000, 128, 128]", permute_28: "f32[4000, 16, 128]", permute_29: "f32[4000, 128, 16]", permute_30: "f32[4000, 16, 128]", div_4: "f32[500, 128, 1]", tangents_1: "f32[500, 128, 128]"):
        ...
        view_17: "f32[64000, 128]" = torch.ops.aten.reshape.default(mul_23, [64000, 128]);  mul_23 = None
        ...
        view_18: "f32[128]" = torch.ops.aten.reshape.default(sum_2, [128]);  sum_2 = None
        view_19: "f32[500, 128, 512]" = torch.ops.aten.reshape.default(mm_1, [500, 128, 512]);  mm_1 = None
        ...
        view_14: "f32[500, 128, 512]" = torch.ops.aten.reshape.default(addmm_2, [500, 128, 512]);  addmm_2 = None
        ...
        # File: /app/src/models/feedforward.py:27 in forward, code: x = self.linear1(x)
        view_20: "f32[64000, 512]" = torch.ops.aten.reshape.default(mul_39, [64000, 512]);  mul_39 = None
        ...
        view_21: "f32[512]" = torch.ops.aten.reshape.default(sum_7, [512]);  sum_7 = None
        view_22: "f32[500, 128, 128]" = torch.ops.aten.reshape.default(mm_3, [500, 128, 128]);  mm_3 = None
        ...
        view_11: "f32[128, 500, 128]" = torch.ops.aten.reshape.default(addmm_1, [128, 500, 128]);  addmm_1 = None
        ...
        view_23: "f32[64000, 128]" = torch.ops.aten.reshape.default(clone_8, [64000, 128]);  clone_8 = None
        ...
        view_24: "f32[128]" = torch.ops.aten.reshape.default(sum_16, [128]);  sum_16 = None
        view_25: "f32[128, 4000, 16]" = torch.ops.aten.reshape.default(mm_5, [128, 4000, 16]);  mm_5 = None
        ...
        view_26: "f32[128, 500, 128]" = torch.ops.aten.reshape.default(clone_10, [128, 500, 128]);  clone_10 = None
        permute_33: "f32[128, 4000, 16]" = torch.ops.aten.permute.default(permute_31, [1, 0, 2]);  permute_31 = None
        view_27: "f32[128, 500, 128]" = torch.ops.aten.reshape.default(permute_33, [128, 500, 128]);  permute_33 = None
        ...
        view_28: "f32[128, 500, 128]" = torch.ops.aten.reshape.default(clone_11, [128, 500, 128]);  clone_11 = None
        ...
        select_scatter_default: "f32[3, 128, 500, 128]" = torch.ops.aten.select_scatter.default(full_default, view_26, 0, 2);  view_26 = None
        select_scatter_default_1: "f32[3, 128, 500, 128]" = torch.ops.aten.select_scatter.default(full_default, view_27, 0, 1);  view_27 = None
        
        # File: /app/src/models/particle_transformer.py:44 in forward, code: x, _ = self.pmha(x, x, x, key_padding_mask=padding_mask, attn_mask=U)
        add_17: "f32[3, 128, 500, 128]" = torch.ops.aten.add.Tensor(select_scatter_default, select_scatter_default_1);  select_scatter_default = select_scatter_default_1 = None
        
        # No stacktrace found for following nodes
        select_scatter_default_2: "f32[3, 128, 500, 128]" = torch.ops.aten.select_scatter.default(full_default, view_28, 0, 0);  full_default = view_28 = None
        
        # File: /app/src/models/particle_transformer.py:44 in forward, code: x, _ = self.pmha(x, x, x, key_padding_mask=padding_mask, attn_mask=U)
        add_18: "f32[3, 128, 500, 128]" = torch.ops.aten.add.Tensor(add_17, select_scatter_default_2);  add_17 = select_scatter_default_2 = None
        ...
        view_29: "f32[128, 500, 384]" = torch.ops.aten.reshape.default(clone_12, [128, 500, 384]);  clone_12 = None
        sum_18: "f32[1, 1, 384]" = torch.ops.aten.sum.dim_IntList(view_29, [0, 1], True)
        view_30: "f32[384]" = torch.ops.aten.reshape.default(sum_18, [384]);  sum_18 = None
        view_31: "f32[64000, 384]" = torch.ops.aten.reshape.default(view_29, [64000, 384]);  view_29 = None
        ...
        view_32: "f32[128, 500, 128]" = torch.ops.aten.reshape.default(mm_8, [128, 500, 128]);  mm_8 = None
        ...
        # File: /app/src/models/feedforward.py:32 in forward, code: x = self.linear2(x)
        view_33: "f32[64000, 128]" = torch.ops.aten.reshape.default(mul_68, [64000, 128]);  mul_68 = None
        ...
        view_34: "f32[128]" = torch.ops.aten.reshape.default(sum_23, [128]);  sum_23 = None
        view_35: "f32[500, 128, 512]" = torch.ops.aten.reshape.default(mm_9, [500, 128, 512]);  mm_9 = None
