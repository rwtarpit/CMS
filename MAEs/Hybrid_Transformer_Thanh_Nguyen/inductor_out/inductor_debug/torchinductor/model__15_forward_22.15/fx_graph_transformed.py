class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[500, 128, 512]", primals_2: "f32[128, 512]", primals_3: "f32[128]", primals_4: "f32[500, 128, 128]", primals_5: "f32[128]", primals_6: "f32[128]", primals_7: "f32[384, 128]", primals_8: "f32[384]", primals_9: "f32[128, 128]", primals_10: "f32[128]", primals_11: "f32[500, 128]", primals_12: "f32[4000, 128, 128]", primals_13: "f32[128]", primals_14: "f32[128]", primals_15: "f32[128]", primals_16: "f32[128]", primals_17: "f32[512, 128]", primals_18: "f32[512]", primals_19: "f32[512]", primals_20: "f32[512]", primals_21: "f32[128, 512]", primals_22: "f32[128]"):
        ...
        view: "f32[64000, 512]" = torch.ops.aten.reshape.default(primals_1, [64000, 512]);  primals_1 = None
        permute: "f32[512, 128]" = torch.ops.aten.permute.default(primals_2, [1, 0])
        mm_default_1: "f32[64000, 128]" = torch.ops.aten.mm.default(view, permute);  permute = None
        add_tensor_1: "f32[64000, 128]" = torch.ops.aten.add.Tensor(primals_3, mm_default_1);  primals_3 = mm_default_1 = None
        view_1: "f32[500, 128, 128]" = torch.ops.aten.reshape.default(add_tensor_1, [500, 128, 128]);  add_tensor_1 = None
        ...
        view_2: "f32[64000, 128]" = torch.ops.aten.reshape.default(clone, [64000, 128]);  clone = None
        mm: "f32[64000, 384]" = torch.ops.aten.mm.default(view_2, permute_2);  permute_2 = None
        view_3: "f32[128, 500, 384]" = torch.ops.aten.reshape.default(mm, [128, 500, 384]);  mm = None
        add_3: "f32[128, 500, 384]" = torch.ops.aten.add.Tensor(view_3, primals_8);  view_3 = primals_8 = None
        view_4: "f32[128, 500, 3, 128]" = torch.ops.aten.reshape.default(add_3, [128, 500, 3, 128]);  add_3 = None
        ...
        view_5: "f32[128, 4000, 16]" = torch.ops.aten.reshape.default(select, [128, 4000, 16]);  select = None
        permute_4: "f32[4000, 128, 16]" = torch.ops.aten.permute.default(view_5, [1, 0, 2]);  view_5 = None
        view_6: "f32[128, 4000, 16]" = torch.ops.aten.reshape.default(select_1, [128, 4000, 16]);  select_1 = None
        permute_5: "f32[4000, 128, 16]" = torch.ops.aten.permute.default(view_6, [1, 0, 2]);  view_6 = None
        view_7: "f32[128, 4000, 16]" = torch.ops.aten.reshape.default(select_2, [128, 4000, 16]);  select_2 = None
        permute_6: "f32[4000, 128, 16]" = torch.ops.aten.permute.default(view_7, [1, 0, 2]);  view_7 = None
        view_8: "f32[500, 1, 1, 128]" = torch.ops.aten.reshape.default(primals_11, [500, 1, 1, 128]);  primals_11 = None
        ...
        view_9: "f32[4000, 1, 128]" = torch.ops.aten.reshape.default(clone_2, [4000, 1, 128]);  clone_2 = None
        ...
        getitem_8: "f32[4000, 128, 1]" = prepare_softmax_online_default[0]
        getitem_9: "f32[4000, 128, 1]" = prepare_softmax_online_default[1];  prepare_softmax_online_default = None
        sub_tensor: "f32[4000, 128, 128]" = torch.ops.aten.sub.Tensor(baddbmm, getitem_8)
        exp_default: "f32[4000, 128, 128]" = torch.ops.aten.exp.default(sub_tensor);  sub_tensor = None
        
        # File: /app/src/models/particle_transformer.py:44 in forward, code: x, _ = self.pmha(x, x, x, key_padding_mask=padding_mask, attn_mask=U)
        div: "f32[4000, 128, 128]" = torch.ops.aten.div.Tensor(exp_default, getitem_9);  exp_default = None
        ...
        view_10: "f32[64000, 128]" = torch.ops.aten.reshape.default(clone_3, [64000, 128]);  clone_3 = None
        ...
        view_11: "f32[128, 500, 128]" = torch.ops.aten.reshape.default(addmm_1, [128, 500, 128])
        ...
        view_13: "f32[64000, 128]" = torch.ops.aten.reshape.default(add_9, [64000, 128]);  add_9 = None
        ...
        view_14: "f32[500, 128, 512]" = torch.ops.aten.reshape.default(addmm_2, [500, 128, 512])
        ...
        # File: /app/src/models/feedforward.py:32 in forward, code: x = self.linear2(x)
        view_15: "f32[64000, 512]" = torch.ops.aten.reshape.default(add_12, [64000, 512]);  add_12 = None
        permute_12: "f32[512, 128]" = torch.ops.aten.permute.default(primals_21, [1, 0])
        mm_default: "f32[64000, 128]" = torch.ops.aten.mm.default(view_15, permute_12);  permute_12 = None
        add_tensor: "f32[64000, 128]" = torch.ops.aten.add.Tensor(primals_22, mm_default);  primals_22 = mm_default = None
        view_16: "f32[500, 128, 128]" = torch.ops.aten.reshape.default(add_tensor, [500, 128, 128]);  add_tensor = None
