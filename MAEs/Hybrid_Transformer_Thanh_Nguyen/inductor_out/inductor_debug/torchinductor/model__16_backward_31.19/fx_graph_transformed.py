class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[1, 1, 128]", primals_4: "f32[128]", primals_8: "f32[128, 128]", primals_10: "f32[128]", primals_12: "f32[128]", primals_14: "f32[512, 128]", primals_16: "f32[512]", cat_1: "f32[500, 129, 128]", getitem_1: "f32[500, 129, 1]", rsqrt: "f32[500, 129, 1]", view_2: "f32[64500, 128]", div: "f32[4000, 1, 129]", view_10: "f32[500, 128]", addmm: "f32[500, 128]", getitem_7: "f32[500, 1, 1]", rsqrt_1: "f32[500, 1, 1]", add_6: "f32[500, 1, 128]", getitem_9: "f32[500, 1, 1]", rsqrt_2: "f32[500, 1, 1]", view_13: "f32[500, 128]", addmm_1: "f32[500, 512]", getitem_11: "f32[500, 1, 1]", rsqrt_3: "f32[500, 1, 1]", permute_24: "f32[4000, 16, 129]", permute_25: "f32[4000, 129, 16]", permute_26: "f32[4000, 16, 1]", permute_34: "f32[256, 128]", permute_38: "f32[128, 128]", tangents_1: "f32[500, 1, 512]", tangents_2: "f32[500, 1, 128]"):
        ...
        view_14: "f32[500, 1, 512]" = torch.ops.aten.reshape.default(addmm_1, [500, 1, 512]);  addmm_1 = None
        ...
        # File: /app/src/models/feedforward.py:27 in forward, code: x = self.linear1(x)
        view_15: "f32[500, 512]" = torch.ops.aten.reshape.default(mul_25, [500, 512]);  mul_25 = None
        ...
        view_16: "f32[512]" = torch.ops.aten.reshape.default(sum_6, [512]);  sum_6 = None
        view_17: "f32[500, 1, 128]" = torch.ops.aten.reshape.default(mm_2, [500, 1, 128]);  mm_2 = None
        ...
        view_11: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(addmm, [1, 500, 128]);  addmm = None
        ...
        view_18: "f32[500, 128]" = torch.ops.aten.reshape.default(permute_17, [500, 128]);  permute_17 = None
        ...
        view_19: "f32[128]" = torch.ops.aten.reshape.default(sum_15, [128]);  sum_15 = None
        view_20: "f32[1, 4000, 16]" = torch.ops.aten.reshape.default(mm_4, [1, 4000, 16]);  mm_4 = None
        ...
        view_21: "f32[129, 500, 128]" = torch.ops.aten.reshape.default(clone_5, [129, 500, 128]);  clone_5 = None
        permute_29: "f32[129, 4000, 16]" = torch.ops.aten.permute.default(permute_27, [1, 0, 2]);  permute_27 = None
        view_22: "f32[129, 500, 128]" = torch.ops.aten.reshape.default(permute_29, [129, 500, 128]);  permute_29 = None
        permute_30: "f32[1, 4000, 16]" = torch.ops.aten.permute.default(mul_41, [1, 0, 2]);  mul_41 = None
        view_23: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(permute_30, [1, 500, 128]);  permute_30 = None
        ...
        select_scatter_default: "f32[2, 129, 500, 128]" = torch.ops.aten.select_scatter.default(full_default_1, view_21, 0, 1);  view_21 = None
        select_scatter_default_1: "f32[2, 129, 500, 128]" = torch.ops.aten.select_scatter.default(full_default_1, view_22, 0, 0);  full_default_1 = view_22 = None
        
        # File: /app/src/models/classifier.py:46 in forward, code: x, _ = self.mha(x_cls, x, x, key_padding_mask=padding_mask)
        add_15: "f32[2, 129, 500, 128]" = torch.ops.aten.add.Tensor(select_scatter_default, select_scatter_default_1);  select_scatter_default = select_scatter_default_1 = None
        ...
        view_24: "f32[129, 500, 256]" = torch.ops.aten.reshape.default(clone_6, [129, 500, 256]);  clone_6 = None
        sum_17: "f32[1, 1, 256]" = torch.ops.aten.sum.dim_IntList(view_24, [0, 1], True)
        view_25: "f32[256]" = torch.ops.aten.reshape.default(sum_17, [256]);  sum_17 = None
        view_26: "f32[64500, 256]" = torch.ops.aten.reshape.default(view_24, [64500, 256]);  view_24 = None
        ...
        view_27: "f32[129, 500, 128]" = torch.ops.aten.reshape.default(mm_7, [129, 500, 128]);  mm_7 = None
        sum_18: "f32[1, 1, 128]" = torch.ops.aten.sum.dim_IntList(view_23, [0, 1], True)
        view_28: "f32[128]" = torch.ops.aten.reshape.default(sum_18, [128]);  sum_18 = None
        view_29: "f32[500, 128]" = torch.ops.aten.reshape.default(view_23, [500, 128]);  view_23 = None
        ...
        view_30: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(mm_9, [1, 500, 128]);  mm_9 = None
