class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[1, 1, 128]", primals_2: "f32[500, 128]", primals_3: "f32[500, 128, 128]", primals_4: "f32[128]", primals_5: "f32[128]", primals_6: "f32[384, 128]", primals_7: "f32[384]", primals_8: "f32[128, 128]", primals_9: "f32[128]", primals_10: "f32[128]", primals_11: "f32[128]", primals_12: "f32[128]", primals_13: "f32[128]", primals_14: "f32[512, 128]", primals_15: "f32[512]", primals_16: "f32[512]", primals_17: "f32[512]"):
        ...
        view_1: "f32[1, 500, 128]" = torch.ops.aten.view.default(mm, [1, 500, 128]);  mm = None
        ...
        view_2: "f32[64500, 128]" = torch.ops.aten.view.default(clone, [64500, 128]);  clone = None
        mm_1: "f32[64500, 256]" = torch.ops.aten.mm.default(view_2, permute_3)
        view_3: "f32[129, 500, 256]" = torch.ops.aten.view.default(mm_1, [129, 500, 256]);  mm_1 = None
        add_3: "f32[129, 500, 256]" = torch.ops.aten.add.Tensor(view_3, getitem_5);  view_3 = getitem_5 = None
        view_4: "f32[129, 500, 2, 128]" = torch.ops.aten.view.default(add_3, [129, 500, 2, 128]);  add_3 = None
        ...
        view_5: "f32[1, 4000, 16]" = torch.ops.aten.view.default(add_2, [1, 4000, 16]);  add_2 = None
        permute_5: "f32[4000, 1, 16]" = torch.ops.aten.permute.default(view_5, [1, 0, 2]);  view_5 = None
        view_6: "f32[129, 4000, 16]" = torch.ops.aten.view.default(select, [129, 4000, 16]);  select = None
        permute_6: "f32[4000, 129, 16]" = torch.ops.aten.permute.default(view_6, [1, 0, 2]);  view_6 = None
        view_7: "f32[129, 4000, 16]" = torch.ops.aten.view.default(select_1, [129, 4000, 16]);  select_1 = None
        permute_7: "f32[4000, 129, 16]" = torch.ops.aten.permute.default(view_7, [1, 0, 2]);  view_7 = None
        view_8: "f32[500, 1, 1, 129]" = torch.ops.aten.view.default(cat, [500, 1, 1, 129]);  cat = None
        ...
        view_9: "f32[4000, 1, 129]" = torch.ops.aten.view.default(clone_2, [4000, 1, 129]);  clone_2 = None
        ...
        view_10: "f32[500, 128]" = torch.ops.aten.view.default(permute_9, [500, 128]);  permute_9 = None
        ...
        view_11: "f32[1, 500, 128]" = torch.ops.aten.view.default(addmm, [1, 500, 128])
        ...
        view_13: "f32[500, 128]" = torch.ops.aten.view.default(add_8, [500, 128]);  add_8 = None
        ...
        view_14: "f32[500, 1, 512]" = torch.ops.aten.view.default(addmm_1, [500, 1, 512])
