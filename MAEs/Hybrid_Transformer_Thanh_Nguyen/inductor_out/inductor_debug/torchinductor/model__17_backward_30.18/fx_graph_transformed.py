class GraphModule(torch.nn.Module):
    def forward(self, primals_2: "f32[128, 512]", primals_7: "f32[128]", primals_11: "f32[128, 128]", primals_13: "f32[128]", primals_15: "f32[128]", primals_17: "f32[512, 128]", primals_19: "f32[512]", primals_21: "f32[128, 512]", primals_23: "f32[128]", primals_25: "f32[10, 128]", view: "f32[500, 512]", cat_1: "f32[500, 129, 128]", getitem_1: "f32[500, 129, 1]", rsqrt: "f32[500, 129, 1]", view_3: "f32[500, 128]", view_5: "f32[64500, 128]", div: "f32[4000, 1, 129]", view_13: "f32[500, 128]", addmm_2: "f32[500, 128]", getitem_7: "f32[500, 1, 1]", rsqrt_1: "f32[500, 1, 1]", mul_5: "f32[500, 1, 128]", view_16: "f32[500, 128]", addmm_3: "f32[500, 512]", getitem_11: "f32[500, 1, 1]", rsqrt_3: "f32[500, 1, 1]", view_18: "f32[500, 512]", mul_12: "f32[500, 1, 128]", squeeze_1: "f32[500, 128]", div_1: "f32[500, 1, 1]", div_3: "f32[500, 1, 1]", permute_37: "f32[4000, 16, 129]", permute_38: "f32[4000, 129, 16]", permute_39: "f32[4000, 16, 1]", permute_47: "f32[256, 128]", permute_49: "f32[128, 128]", tangents_1: "f32[500, 10]"):
        ...
        view_20: "f32[10]" = torch.ops.aten.reshape.default(sum_2, [10]);  sum_2 = None
        ...
        view_21: "f32[500, 128]" = torch.ops.aten.reshape.default(mul_19, [500, 128])
        ...
        view_22: "f32[128]" = torch.ops.aten.reshape.default(sum_7, [128]);  sum_7 = None
        view_23: "f32[500, 1, 512]" = torch.ops.aten.reshape.default(mm_3, [500, 1, 512]);  mm_3 = None
        ...
        view_17: "f32[500, 1, 512]" = torch.ops.aten.reshape.default(addmm_3, [500, 1, 512]);  addmm_3 = None
        ...
        # File: /app/src/models/feedforward.py:27 in forward, code: x = self.linear1(x)
        view_24: "f32[500, 512]" = torch.ops.aten.reshape.default(mul_34, [500, 512]);  mul_34 = None
        ...
        view_25: "f32[512]" = torch.ops.aten.reshape.default(sum_12, [512]);  sum_12 = None
        view_26: "f32[500, 1, 128]" = torch.ops.aten.reshape.default(mm_5, [500, 1, 128]);  mm_5 = None
        ...
        view_14: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(addmm_2, [1, 500, 128]);  addmm_2 = None
        ...
        view_27: "f32[500, 128]" = torch.ops.aten.reshape.default(permute_30, [500, 128]);  permute_30 = None
        ...
        view_28: "f32[128]" = torch.ops.aten.reshape.default(sum_21, [128]);  sum_21 = None
        view_29: "f32[1, 4000, 16]" = torch.ops.aten.reshape.default(mm_7, [1, 4000, 16]);  mm_7 = None
        ...
        view_30: "f32[129, 500, 128]" = torch.ops.aten.reshape.default(clone_7, [129, 500, 128]);  clone_7 = None
        permute_42: "f32[129, 4000, 16]" = torch.ops.aten.permute.default(permute_40, [1, 0, 2]);  permute_40 = None
        view_31: "f32[129, 500, 128]" = torch.ops.aten.reshape.default(permute_42, [129, 500, 128]);  permute_42 = None
        permute_43: "f32[1, 4000, 16]" = torch.ops.aten.permute.default(mul_50, [1, 0, 2]);  mul_50 = None
        view_32: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(permute_43, [1, 500, 128]);  permute_43 = None
        ...
        select_scatter_default: "f32[2, 129, 500, 128]" = torch.ops.aten.select_scatter.default(full_default_1, view_30, 0, 1);  view_30 = None
        select_scatter_default_1: "f32[2, 129, 500, 128]" = torch.ops.aten.select_scatter.default(full_default_1, view_31, 0, 0);  full_default_1 = view_31 = None
        
        # File: /app/src/models/classifier.py:46 in forward, code: x, _ = self.mha(x_cls, x, x, key_padding_mask=padding_mask)
        add_18: "f32[2, 129, 500, 128]" = torch.ops.aten.add.Tensor(select_scatter_default, select_scatter_default_1);  select_scatter_default = select_scatter_default_1 = None
        ...
        view_33: "f32[129, 500, 256]" = torch.ops.aten.reshape.default(clone_8, [129, 500, 256]);  clone_8 = None
        sum_23: "f32[1, 1, 256]" = torch.ops.aten.sum.dim_IntList(view_33, [0, 1], True)
        view_34: "f32[256]" = torch.ops.aten.reshape.default(sum_23, [256]);  sum_23 = None
        view_35: "f32[64500, 256]" = torch.ops.aten.reshape.default(view_33, [64500, 256]);  view_33 = None
        ...
        view_36: "f32[129, 500, 128]" = torch.ops.aten.reshape.default(mm_10, [129, 500, 128]);  mm_10 = None
        view_37: "f32[500, 128]" = torch.ops.aten.reshape.default(view_32, [500, 128]);  view_32 = None
        ...
        view_38: "f32[128]" = torch.ops.aten.reshape.default(sum_24, [128]);  sum_24 = None
        view_39: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(mm_11, [1, 500, 128]);  mm_11 = None
        ...
        # File: /app/src/models/feedforward.py:32 in forward, code: x = self.linear2(x)
        view_40: "f32[500, 128]" = torch.ops.aten.reshape.default(add_20, [500, 128])
        ...
        view_41: "f32[128]" = torch.ops.aten.reshape.default(sum_29, [128]);  sum_29 = None
        view_42: "f32[500, 1, 512]" = torch.ops.aten.reshape.default(mm_13, [500, 1, 512]);  mm_13 = None
