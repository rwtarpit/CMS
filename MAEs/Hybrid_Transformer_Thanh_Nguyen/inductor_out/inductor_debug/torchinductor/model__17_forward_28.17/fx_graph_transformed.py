class GraphModule(torch.nn.Module):
    def forward(self, primals_1: "f32[500, 1, 512]", primals_2: "f32[128, 512]", primals_3: "f32[128]", primals_4: "f32[500, 1, 128]", primals_5: "f32[500, 128]", primals_6: "f32[500, 128, 128]", primals_7: "f32[128]", primals_8: "f32[128]", primals_9: "f32[384, 128]", primals_10: "f32[384]", primals_11: "f32[128, 128]", primals_12: "f32[128]", primals_13: "f32[128]", primals_14: "f32[128]", primals_15: "f32[128]", primals_16: "f32[128]", primals_17: "f32[512, 128]", primals_18: "f32[512]", primals_19: "f32[512]", primals_20: "f32[512]", primals_21: "f32[128, 512]", primals_22: "f32[128]", primals_23: "f32[128]", primals_24: "f32[128]", primals_25: "f32[10, 128]", primals_26: "f32[10]"):
        ...
        view: "f32[500, 512]" = torch.ops.aten.reshape.default(primals_1, [500, 512]);  primals_1 = None
        permute: "f32[512, 128]" = torch.ops.aten.permute.default(primals_2, [1, 0])
        mm_default_2: "f32[500, 128]" = torch.ops.aten.mm.default(view, permute);  permute = None
        add_tensor_2: "f32[500, 128]" = torch.ops.aten.add.Tensor(primals_3, mm_default_2);  primals_3 = mm_default_2 = None
        view_1: "f32[500, 1, 128]" = torch.ops.aten.reshape.default(add_tensor_2, [500, 1, 128]);  add_tensor_2 = None
        ...
        view_3: "f32[500, 128]" = torch.ops.aten.reshape.default(permute_5, [500, 128]);  permute_5 = None
        mm_default_1: "f32[500, 128]" = torch.ops.aten.mm.default(view_3, permute_4)
        add_tensor_1: "f32[500, 128]" = torch.ops.aten.add.Tensor(getitem_4, mm_default_1);  getitem_4 = mm_default_1 = None
        view_4: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(add_tensor_1, [1, 500, 128]);  add_tensor_1 = None
        ...
        view_5: "f32[64500, 128]" = torch.ops.aten.reshape.default(clone_1, [64500, 128]);  clone_1 = None
        mm: "f32[64500, 256]" = torch.ops.aten.mm.default(view_5, permute_6)
        view_6: "f32[129, 500, 256]" = torch.ops.aten.reshape.default(mm, [129, 500, 256]);  mm = None
        add_3: "f32[129, 500, 256]" = torch.ops.aten.add.Tensor(view_6, getitem_5);  view_6 = getitem_5 = None
        view_7: "f32[129, 500, 2, 128]" = torch.ops.aten.reshape.default(add_3, [129, 500, 2, 128]);  add_3 = None
        ...
        view_8: "f32[1, 4000, 16]" = torch.ops.aten.reshape.default(view_4, [1, 4000, 16]);  view_4 = None
        permute_8: "f32[4000, 1, 16]" = torch.ops.aten.permute.default(view_8, [1, 0, 2]);  view_8 = None
        view_9: "f32[129, 4000, 16]" = torch.ops.aten.reshape.default(select, [129, 4000, 16]);  select = None
        permute_9: "f32[4000, 129, 16]" = torch.ops.aten.permute.default(view_9, [1, 0, 2]);  view_9 = None
        view_10: "f32[129, 4000, 16]" = torch.ops.aten.reshape.default(select_1, [129, 4000, 16]);  select_1 = None
        permute_10: "f32[4000, 129, 16]" = torch.ops.aten.permute.default(view_10, [1, 0, 2]);  view_10 = None
        view_11: "f32[500, 1, 1, 129]" = torch.ops.aten.reshape.default(cat, [500, 1, 1, 129]);  cat = None
        ...
        view_12: "f32[4000, 1, 129]" = torch.ops.aten.reshape.default(clone_3, [4000, 1, 129]);  clone_3 = None
        ...
        getitem_14: "f32[4000, 1, 1]" = prepare_softmax_online_default[0]
        getitem_15: "f32[4000, 1, 1]" = prepare_softmax_online_default[1];  prepare_softmax_online_default = None
        sub_tensor: "f32[4000, 1, 129]" = torch.ops.aten.sub.Tensor(baddbmm, getitem_14);  baddbmm = getitem_14 = None
        exp_default: "f32[4000, 1, 129]" = torch.ops.aten.exp.default(sub_tensor);  sub_tensor = None
        
        # File: /app/src/models/classifier.py:46 in forward, code: x, _ = self.mha(x_cls, x, x, key_padding_mask=padding_mask)
        div: "f32[4000, 1, 129]" = torch.ops.aten.div.Tensor(exp_default, getitem_15);  exp_default = getitem_15 = None
        ...
        view_13: "f32[500, 128]" = torch.ops.aten.reshape.default(permute_12, [500, 128]);  permute_12 = None
        ...
        view_14: "f32[1, 500, 128]" = torch.ops.aten.reshape.default(addmm_2, [1, 500, 128])
        ...
        view_16: "f32[500, 128]" = torch.ops.aten.reshape.default(add_8, [500, 128]);  add_8 = None
        ...
        view_17: "f32[500, 1, 512]" = torch.ops.aten.reshape.default(addmm_3, [500, 1, 512])
        ...
        # File: /app/src/models/feedforward.py:32 in forward, code: x = self.linear2(x)
        view_18: "f32[500, 512]" = torch.ops.aten.reshape.default(add_11, [500, 512]);  add_11 = None
        permute_16: "f32[512, 128]" = torch.ops.aten.permute.default(primals_21, [1, 0])
        mm_default: "f32[500, 128]" = torch.ops.aten.mm.default(view_18, permute_16);  permute_16 = None
        add_tensor: "f32[500, 128]" = torch.ops.aten.add.Tensor(primals_22, mm_default);  primals_22 = mm_default = None
        view_19: "f32[500, 1, 128]" = torch.ops.aten.reshape.default(add_tensor, [500, 1, 128]);  add_tensor = None
