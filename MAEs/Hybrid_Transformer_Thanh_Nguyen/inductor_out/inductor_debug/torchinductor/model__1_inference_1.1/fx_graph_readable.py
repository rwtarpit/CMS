class <lambda>(torch.nn.Module):
    def forward(self, arg0_1: "f32[500, 128, 4]"):
        ...
        sin: "f32[500, 128]" = torch.ops.aten.sin.default(select_3)
        ...
        sinh: "f32[500, 128]" = torch.ops.aten.sinh.default(select_2)
        mul_2: "f32[500, 128]" = torch.ops.aten.mul.Tensor(select_1, sinh);  sinh = None
        ...
        unsqueeze_4: "f32[500, 1, 128]" = torch.ops.aten.unsqueeze.default(select_2, 1);  select_2 = None
        ...
        unsqueeze_6: "f32[500, 1, 128]" = torch.ops.aten.unsqueeze.default(select_3, 1);  select_3 = None
        ...
        unsqueeze_10: "f32[500, 1, 128]" = torch.ops.aten.unsqueeze.default(select_1, 1);  select_1 = None
